...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    private static void SeedLookupData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>().HasData(
            new Category { Id = 1, Name = "Salon Halısı" },
            new Category { Id = 2, Name = "Yolluk" },
            new Category { Id = 3, Name = "Çocuk Odası Halısı" },
            new Category { Id = 4, Name = "Mutfak Halısı" },
            new Category { Id = 5, Name = "Klasik Halı" },
            new Category { Id = 6, Name = "Modern Halı" });
